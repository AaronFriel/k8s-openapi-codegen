...
pub struct Container {
    ...
    pub lifecycle: Option<::v1_12::api::core::v1::Lifecycle>,

    /// Periodic probe of container liveness. Container will be restarted if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
    pub liveness_probe: Option<::v1_12::api::core::v1::Probe>,

    /// Name of the container specified as a DNS_LABEL. Each container in a pod must have a unique name (DNS_LABEL). Cannot be updated.
    pub name: String,

    /// List of ports to expose from the container. Exposing a port here gives the system additional information about the network connections a container uses, but is primarily informational. Not specifying a port here DOES NOT prevent that port from being exposed. Any port which is listening on the default "0.0.0.0" address inside a container will be accessible from the network. Cannot be updated.
    pub ports: Option<Vec<::v1_12::api::core::v1::ContainerPort>>,

    /// Periodic probe of container service readiness. Container will be removed from service endpoints if the probe fails. Cannot be updated. More info: https://kubernetes.io/docs/concepts/workloads/pods/pod-lifecycle#container-probes
    pub readiness_probe: Option<::v1_12::api::core::v1::Probe>,
    ...
    pub security_context: Option<::v1_12::api::core::v1::SecurityContext>,
    ...
    pub volume_devices: Option<Vec<::v1_12::api::core::v1::VolumeDevice>>,
    ...
    fn deserialize<D>(deserializer: D) -> Result<Self, D::Error> where D: ::serde::Deserializer<'de> {
        ...
        impl<'de> ::serde::de::Visitor<'de> for Visitor {
            ...
            fn visit_map<A>(self, mut map: A) -> Result<Self::Value, A::Error> where A: ::serde::de::MapAccess<'de> {
                ...
                let mut value_lifecycle: Option<::v1_12::api::core::v1::Lifecycle> = None;
                let mut value_liveness_probe: Option<::v1_12::api::core::v1::Probe> = None;
                let mut value_name: Option<String> = None;
                let mut value_ports: Option<Vec<::v1_12::api::core::v1::ContainerPort>> = None;
                let mut value_readiness_probe: Option<::v1_12::api::core::v1::Probe> = None;
                let mut value_resources: Option<::v1_12::api::core::v1::ResourceRequirements> = None;
                let mut value_security_context: Option<::v1_12::api::core::v1::SecurityContext> = None;
                ...
                let mut value_volume_devices: Option<Vec<::v1_12::api::core::v1::VolumeDevice>> = None;
